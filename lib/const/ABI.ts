export const ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "shieldAddress", type: "address" },
      { internalType: "uint256", name: "shieldFeePerc_", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "hashedPrompt", type: "bytes32" },
    ],
    name: "buyIn",
    outputs: [],
